class Autocomplete {
  ...
  getMatches(text) {
    ...
    */
    ...
    //В экземпляре класса Autocomplete имеется свойство input, которое указывет на тег select. 
    //Его необходимо использовать для обхода по всем опциям списка.
    ...
    arrOptions.forEach(function (item) {
      if (item.textContent.includes(text)) {
        ...
        result.push({ text: optionText, value: value });
      }
    });
